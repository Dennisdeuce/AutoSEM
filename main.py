...
async def lifespan(app: FastAPI):
    ...
    logger.info(f"\u2705 All routers loaded - v{VERSION} Video thumbnail extraction for TikTok ads")
    yield
...
async def health_check():
    return {"status": "healthy", "version": VERSION, "tiktok_router": "loaded", "deploy_router": "loaded",
            "features": ["tt_user_identity", "spark_ads_video", "video_thumbnail_extraction", "auto_thumbnail_upload", "pangle_location_fix", "safe_data_parsing"],
            "identity_strategy": "TT_USER Spark Ads - video-first with extracted thumbnail (v1.0.0)"}
...
<body>
    <div class="container">
        <div class="card">
            ...
            <p class="subtitle">Connect your TikTok Business account and launch campaigns (v1.0.0 - Video Thumbnail Extraction)</p>
        ...
        <div class="card" id="launch-section">
            ...
            <div class="step">
                ...
                <p style="margin-top:8px;color:#667eea"><strong>v1.0.0:</strong> Video Spark Ads with extracted 9:16 thumbnails from video frames</p>
            </div>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Court Sportswear &mdash; Autonomous E-Commerce Advertising Engine v1.0.0</p>
        </div>
        ...
        <div class="footer">AutoSEM v1.0.0 &mdash; Court Sportswear &mdash; Meta + TikTok + Google Ads &mdash; Auto-refreshes every 60s</div>
    </div>
    <script>
        const API = '/api/v1';
