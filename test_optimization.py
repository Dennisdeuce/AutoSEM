...
def test_optimizer_logic():
    ...
    scenarios = [
        {"name": "High ROAS campaign", "impressions": 5000, "clicks": 150, "conversions": 10, "spend": 50.0, "revenue": 150.0, "daily_budget": 10.0, "expected": "budget_increase"},
        {"name": "Low ROAS campaign", "impressions": 5000, "clicks": 100, "conversions": 2, "spend": 75.0, "revenue": 50.0, "daily_budget": 15.0, "expected": "budget_decrease"},
        ...
        {"name": "Low CTR campaign", "impressions": 10000, "clicks": 20, "conversions": 1, "spend": 15.0, "revenue": 30.0, "daily_budget": 10.0, "expected": "flag_low_ctr"},
        {"name": "New campaign - insufficient data", "impressions": 50, "clicks": 2, "conversions": 0, "spend": 3.0, "revenue": 0.0, "daily_budget": 10.0, "expected": "waiting"},
    ]
    passed = 0
    for s in scenarios:
        ...
        elif roas >= 1.5 * 1.5 and s["spend"] > 20: action = "budget_increase"
